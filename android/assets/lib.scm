...
(define (colour-button id text text-size layout col listener) (list "colour-button" id text text-size layout listener col))
...
(define (widget-get-callback w)
  (cond
   ...
   ((equal? (widget-type w) "colour-button") (button-listener w))
        ...
        (let ((events
               (cond
                ...
                ((equal? (callback-type cb) "button")
                 ((callback-fn cb)))
                ((equal? (callback-type cb) "colour-button")
                 ((callback-fn cb)))
